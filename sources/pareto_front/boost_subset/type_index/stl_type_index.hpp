...
#include <pareto_front/boost_subset/type_index/type_index_facade.hpp>
...
#include <pareto_front/boost_subset/core/demangle.hpp>
...
#else
#   include <pareto_front/boost_subset/container_hash/hash.hpp>
#endif

#if (defined(__EDG_VERSION__) && __EDG_VERSION__ < 245) \
        || (defined(__sgi) && defined(_COMPILER_VERSION) && _COMPILER_VERSION <= 744)
#   include <pareto_front/boost_subset/type_traits/is_signed.hpp>
#   include <pareto_front/boost_subset/type_traits/make_signed.hpp>
