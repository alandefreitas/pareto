...
public:
    ...
    /// \note Derived class header \b must include <pareto_front/boost_subset/container_hash/hash.hpp>, \b unless this function is redefined in
...
/// \note <pareto_front/boost_subset/container_hash/hash.hpp> has to be included if this function is used.
template <class Derived, class TypeInfo>
