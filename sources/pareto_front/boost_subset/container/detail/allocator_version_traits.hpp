...
#include <pareto_front/boost_subset/container/allocator_traits.hpp>             //allocator_traits
#include <pareto_front/boost_subset/container/throw_exception.hpp>
#include <pareto_front/boost_subset/container/detail/multiallocation_chain.hpp> //multiallocation_chain
#include <pareto_front/boost_subset/container/detail/version_type.hpp>          //version_type
#include <pareto_front/boost_subset/container/detail/allocation_type.hpp>       //allocation_type
#include <pareto_front/boost_subset/container/detail/mpl.hpp>                   //integral_constant
#include <pareto_front/boost_subset/intrusive/pointer_traits.hpp>               //pointer_traits
#include <pareto_front/boost_subset/core/no_exceptions_support.hpp>             //BOOST_TRY
