...
///
/// Suggested by olafvdspek in https://svn.boost.org/trac/boost_subset/ticket/3215
...
#include <pareto_front/boost_subset/mpl/identity.hpp>      // for identity
#include <pareto_front/boost_subset/utility/enable_if.hpp> // for boost::disable_if
