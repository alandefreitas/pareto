...
#include <pareto_front/boost_subset/bind.hpp>           // for boost::bind
#include <pareto_front/boost_subset/range/begin.hpp>    // for boost::begin(range)
#include <pareto_front/boost_subset/range/end.hpp>      // for boost::end(range)
