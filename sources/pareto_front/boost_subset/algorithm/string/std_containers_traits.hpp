...
#include <pareto_front/boost_subset/algorithm/string/std/string_traits.hpp>
#include <pareto_front/boost_subset/algorithm/string/std/list_traits.hpp>

#ifdef BOOST_HAS_SLIST
#   include <pareto_front/boost_subset/algorithm/string/std/slist_traits.hpp>
#endif
