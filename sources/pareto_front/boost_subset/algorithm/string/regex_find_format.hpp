...
#include <pareto_front/boost_subset/algorithm/string/detail/finder_regex.hpp>
#include <pareto_front/boost_subset/algorithm/string/detail/formatter_regex.hpp>
