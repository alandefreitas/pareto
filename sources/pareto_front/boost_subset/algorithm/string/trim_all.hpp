...
#include <pareto_front/boost_subset/algorithm/string/trim.hpp>
#include <pareto_front/boost_subset/algorithm/string/classification.hpp>
#include <pareto_front/boost_subset/algorithm/string/find_format.hpp>
#include <pareto_front/boost_subset/algorithm/string/formatter.hpp>
#include <pareto_front/boost_subset/algorithm/string/finder.hpp>
#include <locale>
