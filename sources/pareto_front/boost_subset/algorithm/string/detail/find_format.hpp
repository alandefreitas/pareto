...
#include <pareto_front/boost_subset/algorithm/string/detail/find_format_store.hpp>
#include <pareto_front/boost_subset/algorithm/string/detail/replace_storage.hpp>
