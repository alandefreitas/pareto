...
# include <pareto_front/boost_subset/preprocessor/seq/detail/binary_transform.hpp>
#
# /* BOOST_PP_SEQ_TO_LIST */
#
# if BOOST_PP_CONFIG_FLAGS() & BOOST_PP_CONFIG_MSVC()
# include <pareto_front/boost_subset/preprocessor/seq/size.hpp>
# include <pareto_front/boost_subset/preprocessor/seq/detail/to_list_msvc.hpp>
