...
#include <pareto_front/boost_subset/predef/library/c/gnu.h>
#include <pareto_front/boost_subset/predef/os/macos.h>
#include <pareto_front/boost_subset/predef/os/bsd.h>
#include <pareto_front/boost_subset/predef/os/android.h>
...
#if !BOOST_ENDIAN_BIG_BYTE && !BOOST_ENDIAN_BIG_WORD && \
    !BOOST_ENDIAN_LITTLE_BYTE && !BOOST_ENDIAN_LITTLE_WORD
#   include <pareto_front/boost_subset/predef/architecture.h>
#   if BOOST_ARCH_M68K || \
        BOOST_ARCH_PARISC || \
        BOOST_ARCH_SPARC || \
        BOOST_ARCH_SYS370 || \
