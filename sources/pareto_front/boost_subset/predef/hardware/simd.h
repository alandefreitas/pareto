...
#include <pareto_front/boost_subset/predef/hardware/simd/x86.h>
#include <pareto_front/boost_subset/predef/hardware/simd/x86_amd.h>
#include <pareto_front/boost_subset/predef/hardware/simd/arm.h>
#include <pareto_front/boost_subset/predef/hardware/simd/ppc.h>
...
/*`
 ...
 [include ../include/boost_subset/predef/hardware/simd/x86.h]
 [include ../include/boost_subset/predef/hardware/simd/x86_amd.h]
 [include ../include/boost_subset/predef/hardware/simd/arm.h]
 [include ../include/boost_subset/predef/hardware/simd/ppc.h]
 ...
 [include ../include/boost_subset/predef/hardware/simd/x86/versions.h]
 [endsect]

 [section `BOOST_HW_SIMD_X86_AMD_*_VERSION`]
 [include ../include/boost_subset/predef/hardware/simd/x86_amd/versions.h]
 [endsect]

 [section `BOOST_HW_SIMD_ARM_*_VERSION`]
 [include ../include/boost_subset/predef/hardware/simd/arm/versions.h]
 [endsect]

 [section `BOOST_HW_SIMD_PPC_*_VERSION`]
 [include ../include/boost_subset/predef/hardware/simd/ppc/versions.h]
 [endsect]
