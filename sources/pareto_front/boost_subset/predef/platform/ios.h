...
#include <pareto_front/boost_subset/predef/os/ios.h> // BOOST_OS_IOS
#include <pareto_front/boost_subset/predef/version_number.h> // BOOST_VERSION_NUMBER_NOT_AVAILABLE
