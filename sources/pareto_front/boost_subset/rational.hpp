...
#include <pareto_front/boost_subset/config.hpp>      // for BOOST_NO_STDC_NAMESPACE, BOOST_MSVC, etc
...
#include <pareto_front/boost_subset/operators.hpp>   // for boost::addable etc
#include <cstdlib>               // for std::abs
#include <pareto_front/boost_subset/call_traits.hpp> // for boost::call_traits
#include <pareto_front/boost_subset/detail/workaround.hpp> // for BOOST_WORKAROUND
#include <pareto_front/boost_subset/assert.hpp>      // for BOOST_ASSERT
#include <pareto_front/boost_subset/integer/common_factor_rt.hpp> // for boost::integer::gcd, lcm
#include <limits>                // for std::numeric_limits
#include <pareto_front/boost_subset/static_assert.hpp>  // for BOOST_STATIC_ASSERT
