...
#   include <pareto_front/boost_subset/preprocessor/enum_params_with_a_default.hpp>
...
#define BOOST_PP_ITERATION_PARAMS_1 \
    (3,(0, AUX778076_SEQUENCE_LIMIT, <pareto_front/boost_subset/mpl/aux_/sequence_wrapper.hpp>))
