...
#include <pareto_front/boost_subset/numeric/odeint/iterator/integrate/integrate_adaptive.hpp>

// for has_value_type trait
#include <pareto_front/boost_subset/numeric/odeint/algebra/detail/extract_value_type.hpp>
