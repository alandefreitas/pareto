...
#include <pareto_front/boost_subset/intrusive/trivial_value_traits.hpp>
#include <pareto_front/boost_subset/intrusive/slist.hpp> //make_slist
#include <cstddef>
#include <climits>
#include <pareto_front/boost_subset/move/core.hpp>
