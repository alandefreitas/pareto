...
#include <pareto_front/boost_subset/iterator/iterator_traits.hpp> // iterator_difference
...
#include <pareto_front/boost_subset/preprocessor/detail/is_unary.hpp>
#include <pareto_front/boost_subset/preprocessor/list/for_each.hpp>
...
#include <pareto_front/boost_subset/preprocessor/seq/for_each_i.hpp>
#include <pareto_front/boost_subset/preprocessor/seq/size.hpp>
#include <pareto_front/boost_subset/preprocessor/tuple/eat.hpp>
#include <pareto_front/boost_subset/range/const_iterator.hpp>
#include <pareto_front/boost_subset/range/size_type.hpp>
...
#include <pareto_front/boost_subset/utility/addressof.hpp>
#include <pareto_front/boost_subset/utility/enable_if.hpp> // disable_if
#include <pareto_front/boost_subset/next_prior.hpp>

#if !defined(BOOST_RANGE_DETAIL_MICROSOFT_RANGE_VERSION_1)
    #include <pareto_front/boost_subset/range/mutable_iterator.hpp>
#else
...
#include <pareto_front/boost_subset/iterator/iterator_categories.hpp>
#include <pareto_front/boost_subset/iterator/iterator_facade.hpp>
#include <pareto_front/boost_subset/mpl/if.hpp>
#include <pareto_front/boost_subset/type_traits/is_same.hpp>
...
#include <pareto_front/boost_subset/range/empty.hpp>
#include <pareto_front/boost_subset/range/iterator_range.hpp>
#include <pareto_front/boost_subset/range/mutable_iterator.hpp>
#include <pareto_front/boost_subset/range/rbegin.hpp>
#include <pareto_front/boost_subset/range/rend.hpp>
