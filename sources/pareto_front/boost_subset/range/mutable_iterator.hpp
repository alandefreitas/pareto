...
#include <pareto_front/boost_subset/range/detail/extract_optional_type.hpp>
...
#include <pareto_front/boost_subset/range/detail/msvc_has_iterator_workaround.hpp>
