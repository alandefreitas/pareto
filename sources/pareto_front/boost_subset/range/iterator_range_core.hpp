...
#include <pareto_front/boost_subset/config.hpp> // Define __STL_CONFIG_H, if appropriate.
...
#include <pareto_front/boost_subset/type_traits/is_abstract.hpp>
#include <pareto_front/boost_subset/type_traits/is_array.hpp>
#include <pareto_front/boost_subset/type_traits/is_base_and_derived.hpp>
#include <pareto_front/boost_subset/type_traits/is_convertible.hpp>
#include <pareto_front/boost_subset/type_traits/is_function.hpp>
...
#include <pareto_front/boost_subset/range/has_range_iterator.hpp>
#include <pareto_front/boost_subset/range/algorithm/equal.hpp>
#include <pareto_front/boost_subset/range/detail/safe_bool.hpp>
