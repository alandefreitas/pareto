...
#include <pareto_front/boost_subset/qvm/quat_traits.hpp>
#include <pareto_front/boost_subset/qvm/deduce_vec.hpp>
#include <pareto_front/boost_subset/qvm/static_assert.hpp>
