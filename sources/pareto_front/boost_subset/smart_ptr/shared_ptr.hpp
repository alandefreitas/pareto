...
#include <pareto_front/boost_subset/config.hpp>   // for broken compiler workarounds

// In order to avoid circular dependencies with Boost.TR1
// we make sure that our include of <memory> doesn't try to
// pull in the TR1 headers: that's why we use this header 
// rather than including <memory> directly:
#include <pareto_front/boost_subset/config/no_tr1/memory.hpp>  // std::auto_ptr

#include <pareto_front/boost_subset/assert.hpp>
#include <pareto_front/boost_subset/checked_delete.hpp>
#include <pareto_front/boost_subset/throw_exception.hpp>
#include <pareto_front/boost_subset/smart_ptr/detail/shared_count.hpp>
#include <pareto_front/boost_subset/detail/workaround.hpp>
#include <pareto_front/boost_subset/smart_ptr/detail/sp_convertible.hpp>
#include <pareto_front/boost_subset/smart_ptr/detail/sp_nullptr_t.hpp>
#include <pareto_front/boost_subset/smart_ptr/detail/sp_disable_deprecated.hpp>
#include <pareto_front/boost_subset/smart_ptr/detail/sp_noexcept.hpp>

#if !defined(BOOST_SP_NO_ATOMIC_ACCESS)
#include <pareto_front/boost_subset/smart_ptr/detail/spinlock_pool.hpp>
#endif
...
#include <pareto_front/boost_subset/smart_ptr/detail/operator_bool.hpp>
...
#include <pareto_front/boost_subset/smart_ptr/detail/local_sp_deleter.hpp>
