...
// Several changes/additions according to suggrestions by Douglas Gregor,
...
#include <pareto_front/boost_subset/utility/swap.hpp>

#include <pareto_front/boost_subset/detail/workaround.hpp> // needed for BOOST_WORKAROUND
