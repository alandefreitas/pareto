...
//   01 Apr 01  Modified to use new <pareto_front/boost_subset/limits.hpp> header. (John Maddock)
...
#include <pareto_front/boost_subset/integer_fwd.hpp>  // self include

#include <pareto_front/boost_subset/integer_traits.hpp>  // for boost::::boost::integer_traits
#include <pareto_front/boost_subset/limits.hpp>          // for ::std::numeric_limits
#include <pareto_front/boost_subset/cstdint.hpp>         // for boost::int64_t and BOOST_NO_INTEGRAL_INT64_T
