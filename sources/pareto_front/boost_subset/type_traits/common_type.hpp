...
#include <pareto_front/boost_subset/type_traits/decay.hpp>
...
#include <pareto_front/boost_subset/type_traits/detail/common_type_impl.hpp>
#endif

#if !defined(BOOST_NO_CXX11_TEMPLATE_ALIASES) && !defined(BOOST_NO_CXX11_VARIADIC_TEMPLATES)
#include <pareto_front/boost_subset/type_traits/detail/mp_defer.hpp>
#endif
