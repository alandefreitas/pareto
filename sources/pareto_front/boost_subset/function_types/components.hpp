...
#include <pareto_front/boost_subset/detail/workaround.hpp>
...
#include <pareto_front/boost_subset/mpl/vector/vector0.hpp>

#if BOOST_WORKAROUND(__BORLANDC__, <= 0x565)
#   include <pareto_front/boost_subset/type_traits/remove_cv.hpp>

#   include <pareto_front/boost_subset/mpl/identity.hpp>
#   include <pareto_front/boost_subset/mpl/bitand.hpp>
#   include <pareto_front/boost_subset/mpl/vector/vector10.hpp>
#   include <pareto_front/boost_subset/mpl/front.hpp>
#   include <pareto_front/boost_subset/mpl/begin.hpp>
#   include <pareto_front/boost_subset/mpl/advance.hpp>
#   include <pareto_front/boost_subset/mpl/iterator_range.hpp>
#   include <pareto_front/boost_subset/mpl/joint_view.hpp>
#   include <pareto_front/boost_subset/mpl/equal_to.hpp>
#   include <pareto_front/boost_subset/mpl/copy.hpp>
#   include <pareto_front/boost_subset/mpl/front_inserter.hpp>

#   include <pareto_front/boost_subset/function_types/detail/classifier.hpp>
#endif

#ifndef BOOST_FT_NO_CV_FUNC_SUPPORT
#   include <pareto_front/boost_subset/mpl/remove.hpp>
#endif

#include <pareto_front/boost_subset/function_types/config/config.hpp>

#   if   BOOST_FT_MAX_ARITY < 10
#     include <pareto_front/boost_subset/mpl/vector/vector10.hpp>
#   elif BOOST_FT_MAX_ARITY < 20
#     include <pareto_front/boost_subset/mpl/vector/vector20.hpp>
#   elif BOOST_FT_MAX_ARITY < 30
#     include <pareto_front/boost_subset/mpl/vector/vector30.hpp>
#   elif BOOST_FT_MAX_ARITY < 40
#     include <pareto_front/boost_subset/mpl/vector/vector40.hpp>
#   elif BOOST_FT_MAX_ARITY < 50
#     include <pareto_front/boost_subset/mpl/vector/vector50.hpp>
#   endif

#include <pareto_front/boost_subset/function_types/detail/class_transform.hpp>
#include <pareto_front/boost_subset/function_types/property_tags.hpp>
...
#define BOOST_FT_al_path pareto_front/boost_subset/function_types/detail/components_impl
#include <pareto_front/boost_subset/function_types/detail/pp_loop.hpp>

  } } // namespace function_types::detail

} // namespace ::boost

#include <pareto_front/boost_subset/function_types/detail/components_as_mpl_sequence.hpp>
#include <pareto_front/boost_subset/function_types/detail/retag_default_cc.hpp>
