...
#   define BOOST_FT_loop <pareto_front/boost_subset/function_types/detail/pp_cc_loop/master.hpp>
#else
#   define BOOST_FT_loop \
        <pareto_front/boost_subset/function_types/detail/pp_cc_loop/preprocessed.hpp>
#endif

#if defined(BOOST_FT_al_path)

#   define BOOST_FT_cc_file \
        <pareto_front/boost_subset/function_types/detail/pp_variate_loop/preprocessed.hpp>
#   define BOOST_FT_variate_file \
        <pareto_front/boost_subset/function_types/detail/pp_arity_loop.hpp>
