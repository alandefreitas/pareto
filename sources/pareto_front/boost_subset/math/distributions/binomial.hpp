...
#include <pareto_front/boost_subset/math/special_functions/beta.hpp> // for incomplete beta.
...
#include <pareto_front/boost_subset/math/distributions/detail/inv_discrete_quantile.hpp> // error checks
