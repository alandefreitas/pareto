...
#include <pareto_front/boost_subset/math/special_functions/beta.hpp> // for ibeta(a, b, x) == Ix(a, b).
#include <pareto_front/boost_subset/math/distributions/complement.hpp> // complement.
#include <pareto_front/boost_subset/math/distributions/detail/common_error_handling.hpp> // error checks domain_error & logic_error.
