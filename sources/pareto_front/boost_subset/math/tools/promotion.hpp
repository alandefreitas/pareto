...
#include <pareto_front/boost_subset/type_traits/is_floating_point.hpp> // for boost::is_floating_point;
#include <pareto_front/boost_subset/type_traits/is_integral.hpp> // for boost::is_integral
#include <pareto_front/boost_subset/type_traits/is_convertible.hpp> // for boost::is_convertible
#include <pareto_front/boost_subset/type_traits/is_same.hpp>// for boost::is_same
#include <pareto_front/boost_subset/type_traits/remove_cv.hpp>// for boost::remove_cv
// Boost Template meta programming:
#include <pareto_front/boost_subset/mpl/if.hpp> // for boost::mpl::if_c.
#include <pareto_front/boost_subset/mpl/and.hpp> // for boost::mpl::if_c.
#include <pareto_front/boost_subset/mpl/or.hpp> // for boost::mpl::if_c.
#include <pareto_front/boost_subset/mpl/not.hpp> // for boost::mpl::if_c.
