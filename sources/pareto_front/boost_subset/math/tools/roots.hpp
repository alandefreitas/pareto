...
#pragma once
#endif
#include <pareto_front/boost_subset/multiprecision/detail/number_base.hpp> // test for multiprecision types.
#include <pareto_front/boost_subset/type_traits/is_complex.hpp> // test for complex types
...
#include <pareto_front/boost_subset/math/special_functions/sign.hpp>
#include <pareto_front/boost_subset/math/special_functions/next.hpp>
#include <pareto_front/boost_subset/math/tools/toms748_solve.hpp>
         ...
         else
         {
            if(f2 != 0)
            {
               ...
               if(delta * f1 / f0 < 0)
               {
                  ...
                  // See https://svn.boost.org/trac/boost_subset/ticket/8314.
                  delta = f0 / f1;
