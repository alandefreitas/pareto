...
#include <pareto_front/boost_subset/math/policies/policy.hpp>
...
#include <pareto_front/boost_subset/math/special_functions/log1p.hpp> // for log (1 + x)
#include <pareto_front/boost_subset/math/constants/constants.hpp> // For exp_minus_one == 3.67879441171442321595523770161460867e-01.
#include <pareto_front/boost_subset/math/special_functions/pow.hpp> // powers with compile time exponent, used in arbitrary precision code.
#include <pareto_front/boost_subset/math/tools/series.hpp> // series functor.
//#include <pareto_front/boost_subset/math/tools/polynomial.hpp>  // polynomial.
#include <pareto_front/boost_subset/math/tools/rational.hpp>  // evaluate_polynomial.
#include <pareto_front/boost_subset/mpl/int.hpp>
#include <pareto_front/boost_subset/type_traits/is_integral.hpp>
#include <pareto_front/boost_subset/math/tools/precision.hpp> // boost::math::tools::max_value().
#include <pareto_front/boost_subset/math/tools/big_constant.hpp>
...
#include <iostream>
#include <typeinfo>
#include <pareto_front/boost_subset/math/special_functions/next.hpp>  // For float_distance.
...
#include <pareto_front/boost_subset/math/special_functions/detail/lambert_w_lookup_table.ipp>
