...
#include <pareto_front/boost_subset/config.hpp> // for BOOST_NO_STD_LOCALE
#include <pareto_front/boost_subset/math_fwd.hpp>
...
#include <pareto_front/boost_subset/math/special_functions/sinc.hpp>    // for the Sinus cardinal
#include <pareto_front/boost_subset/math/special_functions/sinhc.hpp>    // for the Hyperbolic Sinus cardinal
