...
class Polygon
{
    ...
    struct checker
    {
        ...
        {
            [[maybe_unused]] polygon_type* poly = 0;
            [[maybe_unused]] polygon_type const* cpoly = poly;

            [[maybe_unused]] ring_mutable_type e = traits::exterior_ring<PolygonType>::get(*poly);
            [[maybe_unused]] interior_mutable_type i = traits::interior_rings<PolygonType>::get(*poly);
            [[maybe_unused]] ring_const_type ce = traits::exterior_ring<PolygonType>::get(*cpoly);
            [[maybe_unused]] interior_const_type ci = traits::interior_rings<PolygonType>::get(*cpoly);
...
class ConstPolygon
{
    ...
    struct checker
    {
        static inline void apply()
        {
            [[maybe_unused]] const_polygon_type const* cpoly = 0;

            [[maybe_unused]] ring_const_type ce = traits::exterior_ring<const_polygon_type>::get(*cpoly);
            [[maybe_unused]] interior_const_type ci = traits::interior_rings<const_polygon_type>::get(*cpoly);
