...
private:
    ...
    inline static
    subtree_elements_counts calculate_subtree_elements_counts(std::size_t elements_count, [[maybe_unused]] parameters_type const& parameters, size_type & leafs_level)
    {
