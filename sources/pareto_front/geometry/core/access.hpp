...
#include <pareto_front/geometry/util/bare_type.hpp>
...
inline typename coordinate_type<Geometry>::type get(Geometry const& geometry
        ...
        , [[maybe_unused]] detail::signature_getset_dimension* dummy = 0
#endif
        )
{
...
inline typename coordinate_type<Geometry>::type get(Geometry const& geometry
#ifndef DOXYGEN_SHOULD_SKIP_THIS
        , [[maybe_unused]] detail::signature_getset_index_dimension* dummy = 0
#endif
        )
{
    // boost::ignore_unused(dummy);
