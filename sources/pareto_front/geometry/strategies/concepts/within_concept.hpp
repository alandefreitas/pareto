...
#include <pareto_front/geometry/util/parameter_type_of.hpp>
...
class WithinStrategyPolygonal
{
    ...
    struct checker
    {
        ...
        static void apply(ApplyMethod, ResultMethod)
        {
            ...
            [[maybe_unused]] Strategy const* str = 0;
            state_type* st = 0;
            point_type const* p = 0;
            segment_point_type const* sp = 0;

            [[maybe_unused]] bool b = str->apply(*p, *sp, *sp, *st);
            [[maybe_unused]] int r = str->result(*st);
...
class WithinStrategyPointBox
{
    ...
    struct checker
    {
        ...
        static void apply(ApplyMethod)
        {
            ...
            [[maybe_unused]] bool b = str->apply(*p, *bx);
...
class WithinStrategyBoxBox
{
    ...
    struct checker
    {
        ...
        static void apply(ApplyMethod const&)
        {
            ...
            [[maybe_unused]] bool b = str->apply(*b1, *b2);
...
inline void check()
{
    [[maybe_unused]] dispatch::check_within
        <
            Geometry1,
            Geometry2,
