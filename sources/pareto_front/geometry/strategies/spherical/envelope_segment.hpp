...
#include <pareto_front/geometry/algorithms/detail/envelope/transform_units.hpp>
...
#include <pareto_front/geometry/formulas/meridian_segment.hpp>
#include <pareto_front/geometry/formulas/vertex_latitude.hpp>

#include <pareto_front/geometry/geometries/helper_geometry.hpp>
...
#include <pareto_front/geometry/strategies/normalize.hpp>
...
private:
    ...
    static inline void compute_box_corners([[maybe_unused]] CalculationType& lon1,
                                           CalculationType& lat1,
                                           [[maybe_unused]] CalculationType& lon2,
                                           CalculationType& lat2,
                                           CalculationType a1,
                                           CalculationType a2,
                                           Strategy const& strategy)
