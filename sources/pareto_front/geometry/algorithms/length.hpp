...
#include <pareto_front/boost_subset/mpl/set.hpp>
...
#include <pareto_front/geometry/strategies/default_length_result.hpp>
...
struct segment_length
{
    ...
    static inline typename default_length_result<Segment>::type apply(
            Segment const& segment, [[maybe_unused]] Strategy const& strategy)
    {
...
struct range_length
{
    ...
    static inline return_type apply(
            Range const& range, [[maybe_unused]] Strategy const& strategy)
    {
        // boost::ignore_unused(strategy);
