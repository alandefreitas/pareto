...
#include <pareto_front/geometry/strategies/concepts/within_concept.hpp>
...
int point_in_range(Point const& point, Range const& range, [[maybe_unused]] Strategy const& strategy)
{
...
struct point_in_geometry<Point2, point_tag>
{
    ...
    int apply(Point1 const& point1, Point2 const& point2, [[maybe_unused]] Strategy const& strategy)
    {
        // boost::ignore_unused(strategy);
...
struct point_in_geometry<Segment, segment_tag>
{
    ...
    int apply(Point const& point, Segment const& segment, [[maybe_unused]] Strategy const& strategy)
    {
        // boost::ignore_unused(strategy);
