...
#include <pareto_front/geometry/algorithms/detail/within/multi_point.hpp>
#include <pareto_front/geometry/algorithms/detail/within/point_in_geometry.hpp>
...
struct within<Point, Box, point_tag, box_tag>
{
    ...
    static inline bool apply(Point const& point, Box const& box, [[maybe_unused]] Strategy const& strategy)
    {
...
{
    template <typename Strategy>
    static inline bool apply(Box1 const& box1, Box2 const& box2, [[maybe_unused]] Strategy const& strategy)
    {
...
#include <pareto_front/geometry/index/rtree.hpp>
