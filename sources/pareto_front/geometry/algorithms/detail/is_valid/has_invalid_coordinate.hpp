...
#include <pareto_front/geometry/util/has_non_finite_coordinate.hpp>
...
struct point_has_invalid_coordinate
{
    ...
    static inline bool apply(Point const& point, [[maybe_unused]] VisitPolicy& visitor)
    {
...
struct range_has_invalid_coordinate
{
    ...
    template <typename Geometry, typename VisitPolicy>
    static inline bool apply(Geometry const& geometry, [[maybe_unused]] VisitPolicy& visitor)
    {
        // boost::ignore_unused(visitor);
