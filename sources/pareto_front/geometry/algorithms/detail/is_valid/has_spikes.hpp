...
#include <pareto_front/geometry/policies/is_valid/default_policy.hpp>
...
#include <pareto_front/geometry/algorithms/detail/point_is_spike_or_equal.hpp>
...
struct has_spikes
{
    ...
    static inline bool apply_at_closure(View const& view, [[maybe_unused]] VisitPolicy& visitor,
    ...
    static inline bool apply(Range const& range, [[maybe_unused]] VisitPolicy& visitor,
                             SideStrategy const& strategy)
    {
        // boost::ignore_unused(visitor);
