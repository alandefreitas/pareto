...
#include <pareto_front/geometry/algorithms/detail/num_distinct_consecutive_points.hpp>
#include <pareto_front/geometry/algorithms/detail/is_valid/has_duplicates.hpp>
#include <pareto_front/geometry/algorithms/detail/is_valid/has_invalid_coordinate.hpp>
...
struct is_topologically_closed
{
    ...
    static inline bool apply(Ring const&, [[maybe_unused]] VisitPolicy& visitor, EqPPStrategy const&)
    {
...
{
    template <typename VisitPolicy, typename EqPPStrategy>
    static inline bool apply(Ring const& ring, [[maybe_unused]] VisitPolicy& visitor, EqPPStrategy const&)
    {
        // boost::ignore_unused(visitor);
...
struct is_properly_oriented
{
    ...
    static inline bool apply(Ring const& ring, [[maybe_unused]] VisitPolicy& visitor,
