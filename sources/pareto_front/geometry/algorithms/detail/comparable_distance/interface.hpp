...
#include <pareto_front/geometry/strategies/comparable_distance_result.hpp>
#include <pareto_front/geometry/strategies/default_comparable_distance_result.hpp>
