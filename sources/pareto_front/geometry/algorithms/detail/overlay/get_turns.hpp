...
#include <pareto_front/boost_subset/mpl/vector_c.hpp>
...
#include <pareto_front/geometry/core/reverse_dispatch.hpp>
...
#include <pareto_front/geometry/views/detail/range_type.hpp>

#include <pareto_front/geometry/geometries/box.hpp>
#include <pareto_front/geometry/geometries/segment.hpp>

#include <pareto_front/geometry/iterators/ever_circling_iterator.hpp>

#include <pareto_front/geometry/strategies/intersection_strategies.hpp>
#include <pareto_front/geometry/strategies/intersection_result.hpp>

#include <pareto_front/geometry/algorithms/detail/disjoint/box_box.hpp>
#include <pareto_front/geometry/algorithms/detail/disjoint/point_point.hpp>

#include <pareto_front/geometry/algorithms/detail/interior_iterator.hpp>
#include <pareto_front/geometry/algorithms/detail/partition.hpp>
#include <pareto_front/geometry/algorithms/detail/recalculate.hpp>
#include <pareto_front/geometry/algorithms/detail/sections/section_box_policies.hpp>

#include <pareto_front/geometry/algorithms/detail/overlay/get_turn_info.hpp>
#include <pareto_front/geometry/algorithms/detail/overlay/get_turn_info_ll.hpp>
#include <pareto_front/geometry/algorithms/detail/overlay/get_turn_info_la.hpp>
#include <pareto_front/geometry/algorithms/detail/overlay/segment_identifier.hpp>

#include <pareto_front/geometry/algorithms/detail/sections/range_by_section.hpp>
#include <pareto_front/geometry/algorithms/detail/sections/sectionalize.hpp>
#include <pareto_front/geometry/algorithms/detail/sections/section_functions.hpp>
...
class get_turns_in_sections
{
    ...
    static inline bool adjacent(Section const& section,
                                [[maybe_unused]] signed_size_type index1,
                                [[maybe_unused]] signed_size_type index2)
    {
        // About n-2:
        ...
        [[maybe_unused]] signed_size_type const n = static_cast<signed_size_type>(section.range_count);
...
public :
    ...
    static inline bool apply(
            ...
            RobustPolicy const& robust_policy,
            Turns& turns,
            [[maybe_unused]] InterruptPolicy& interrupt_policy)
    {
