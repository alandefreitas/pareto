...
#include <pareto_front/geometry/algorithms/detail/overlay/get_distance_measure.hpp>
...
#include <pareto_front/geometry/algorithms/detail/overlay/get_turn_info_helpers.hpp>
...
struct base_turn_handler
{
    ...
    static inline void both_collinear(
            [[maybe_unused]] UniqueSubRange1 const& range_p,
            [[maybe_unused]] UniqueSubRange2 const& range_q,
...
private :
    ...
    */
    ...
    <
        ...
        typename IntersectionInfo
    >
    static inline bool set_tp(int side_rk_r, [[maybe_unused]] bool handle_robustness,
                              [[maybe_unused]] int side_rk_s,
