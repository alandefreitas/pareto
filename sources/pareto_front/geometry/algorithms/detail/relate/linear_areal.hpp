...
#include <pareto_front/boost_subset/range/size.hpp>
...
#include <pareto_front/geometry/algorithms/detail/sub_range.hpp>
#include <pareto_front/geometry/algorithms/detail/single_geometry.hpp>

#include <pareto_front/geometry/algorithms/detail/relate/point_geometry.hpp>
#include <pareto_front/geometry/algorithms/detail/relate/turns.hpp>
#include <pareto_front/geometry/algorithms/detail/relate/boundary_checker.hpp>
#include <pareto_front/geometry/algorithms/detail/relate/follow_helpers.hpp>

#include <pareto_front/geometry/views/detail/normalized_view.hpp>
...
// TODO: calculate_from_inside() is only needed if the current Linestring is not closed
        ...
        void apply(Result & res,
                   [[maybe_unused]] TurnIt first, [[maybe_unused]] TurnIt last,
                   Geometry const& geometry,
                   OtherGeometry const& /*other_geometry*/,
                   BoundaryChecker const& boundary_checker)
        {
