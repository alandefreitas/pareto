...
#include <pareto_front/geometry/algorithms/detail/closest_feature/geometry_to_range.hpp>
...
struct point_to_point
{
    ...
    apply(P1 const& p1, P2 const& p2, [[maybe_unused]] Strategy const& strategy)
    {
    ...
    >
{
    static inline typename strategy::distance::services::return_type
        ...
        >::type
    apply(Point const& point, Box const& box, [[maybe_unused]] Strategy const& strategy)
    {
        // boost::ignore_unused(strategy);
