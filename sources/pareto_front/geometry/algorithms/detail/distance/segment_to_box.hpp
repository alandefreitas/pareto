...
#include <pareto_front/boost_subset/numeric/conversion/cast.hpp>
...
#include <pareto_front/geometry/algorithms/detail/assign_box_corners.hpp>
#include <pareto_front/geometry/algorithms/detail/assign_indexed_point.hpp>
#include <pareto_front/geometry/algorithms/detail/closest_feature/point_to_range.hpp>
#include <pareto_front/geometry/algorithms/detail/disjoint/segment_box.hpp>
#include <pareto_front/geometry/algorithms/detail/distance/default_strategies.hpp>
...
#include <pareto_front/geometry/util/calculation_type.hpp>
...
public:
                                    ...
                                    bool check_intersection = true)
    {
        ...
        [[maybe_unused]] comparable_strategy cstrategy =
            strategy::distance::services::get_comparable
                <
                    Strategy
                >::apply(strategy);
        ...
        [[maybe_unused]] point_box_comparable_strategy pb_cstrategy;
...
private:
    ...
    struct right_of_box
    {
        static inline ReturnType apply(SegmentPoint const& p0,
                                       ...
                                       [[maybe_unused]] SBStrategy const& sb_strategy)
        {
