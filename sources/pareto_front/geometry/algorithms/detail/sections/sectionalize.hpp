...
#include <pareto_front/geometry/algorithms/detail/expand_by_epsilon.hpp>
#include <pareto_front/geometry/strategies/envelope.hpp>
#include <pareto_front/geometry/strategies/expand.hpp>
...
struct sectionalize_part
{
    ...
    static inline void apply(Sections& sections,
                             Iterator begin, Iterator end,
                             [[maybe_unused]] RobustPolicy const& robust_policy,
