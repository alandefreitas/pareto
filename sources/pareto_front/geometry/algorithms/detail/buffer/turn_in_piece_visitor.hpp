...
#include <pareto_front/geometry/core/config.hpp>
...
#include <pareto_front/geometry/strategies/cartesian/side_of_intersection.hpp>
...
struct check_helper_segment<true>
{
    ...
    static inline analyse_result apply(Point const& s1,
                Point const& s2, Turn const& turn,
                                       [[maybe_unused]] bool is_original,
                                       [[maybe_unused]] Point const& offsetted)
    {
...
public:
    ...
    template <typename Turn, typename Piece>
    inline bool apply(Turn const& turn, Piece const& piece, [[maybe_unused]] bool first = true)
    {
        ...
        [[maybe_unused]] static const bool use_soi = use_side_of_intersection<CsTag>::value;
