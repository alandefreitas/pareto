...
<
    ...
    typename Iterator
>
inline bool point_in_range([[maybe_unused]] Strategy& strategy, State& state,
...
public:
    ...
    inline bool apply(Turn const& turn, Original const& original, [[maybe_unused]] bool first = true)
    {
