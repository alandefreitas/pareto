...
#include <pareto_front/geometry/algorithms/detail/buffer/buffered_piece_collection.hpp>
#include <pareto_front/geometry/algorithms/detail/buffer/line_line_intersection.hpp>
#include <pareto_front/geometry/algorithms/detail/buffer/parallel_continue.hpp>
...
struct buffer_range
{
    ...
    static inline geometry::strategy::buffer::result_code iterate(Collection& collection,
                ...
                DistanceStrategy const& distance_strategy,
                                                                  [[maybe_unused]] SideStrategy const& side_strategy,
                JoinStrategy const& join_strategy,
                EndStrategy const& end_strategy,
...
inline void buffer_inserter(GeometryInput const& geometry_input, OutputIterator out,
        ...
        RobustPolicy const& robust_policy,
                            [[maybe_unused]] VisitPiecesPolicy& visit_pieces_policy
    )
{
