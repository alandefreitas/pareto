...
namespace pareto {
    ...
    public:
        ...
        static constexpr size_t RTREE_CHOOSE_SUBTREE_P = 32;
    ...
    public /* iterators */:
        ...
        private:
            void advance_if_invalid() {
                ...
                if (current_node_->is_leaf_node()) {
                    ...
                    if (nearest_predicate_ == nullptr) {
                        ...
                        if (!passes_predicates(current_node_->branches_[current_branch_].as_value())) {
            ...
            void advance_to_next_valid_through_nearest() {
                ...
                // The first steps were executed in 'normalize_nearest_queries'
                ...
                while (!nearest_queue_.empty()) {
                    ...
                    if (element.is_value()) {
                        ...
                        if (passes_predicates(element.as_value())) {
                            ++nearest_points_iterated_;
    ...
    public /* iterators */:
        ...
        const_iterator find(const value_type &v) const {
            const_iterator it = begin_intersection(v.first, v.first,
                                                   [&v](const value_type &x) { return true; });
            it.predicates_.clear();
            return it;
        }
    ...
    protected:
        ...
        insert_branch(const branch_variant &branch, rstar_tree_node *&root_node, size_t a_level, bool first_insert) {
            ...
            auto result_tuple = insert_branch_recursive(branch, root_node, new_rstar_tree_node, a_level, first_insert);
            // If the root split
        ...
        split_rstar_tree_node(rstar_tree_node *&old_node, const branch_variant &branch_to_insert, rstar_tree_node *&new_tree_node, bool first_insert) {
            assert(old_node);
        ...
        void choose_partition(partition_vars &a_par_vars, size_t a_min_fill) {
            ...
            a_par_vars.count_.first = split_index;
            std::fill(a_par_vars.partition_.begin() + split_index, a_par_vars.partition_.end(), 1);
            a_par_vars.count_.second = a_par_vars.total_ - split_index;
        ...
        void apply_reinsert_list(rstar_tree_node *&root_node, node_list &reinsert_list) {
            ...
            while (!reinsert_list.empty()) {
                ...
                for (int index = 0; index < temp_rstar_tree_node->count_; ++index) {
