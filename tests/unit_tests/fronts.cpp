    ...
    do {
        ...
        SECTION(section_name) {
            ...
            SECTION("Constructors") {
                ...
                if (test_dimension == 2) {
                    // initializer list
                    pareto_front_t pf9({{{2.6, 3.4}, 6},
                                        {{6.5, 2.4}, 4}});
                    // initializer list and direction
                    pareto_front_t pf10({{{2.6, 3.4}, 6},
                                         {{6.5, 2.4}, 4}}, false);
                }
                // vector
...
TEST_CASE("Front - 1 dimension") {
    ...
    test_front<0, quad_tree_tag>(1);
    test_front<1, kd_tree_tag>(1);
    test_front<0, kd_tree_tag>(1);
    test_front<1, boost_tree_tag>(1);
    test_front<1, r_tree_tag>(1);
    test_front<0, r_tree_tag>(1);
...
TEST_CASE("Front - 2 dimensions") {
    ...
    test_front<0, quad_tree_tag>(2);
    test_front<2, kd_tree_tag>(2);
    test_front<0, kd_tree_tag>(2);
    test_front<2, boost_tree_tag>(2);
    test_front<2, r_tree_tag>(2);
    test_front<0, r_tree_tag>(2);
    test_front<2, r_star_tree_tag>(2);
...
TEST_CASE("Front - 3 dimensions") {
    ...
    test_front<0, quad_tree_tag>(3);
    test_front<3, kd_tree_tag>(3);
    test_front<0, kd_tree_tag>(3);
    test_front<3, boost_tree_tag>(3);
    test_front<3, r_tree_tag>(3);
    test_front<0, r_tree_tag>(3);
    test_front<3, r_star_tree_tag>(3);
    test_front<0, r_star_tree_tag>(3);
}
...
TEST_CASE("Front - 5 dimensions") {
    ...
    test_front<0, quad_tree_tag>(5);
    test_front<5, kd_tree_tag>(5);
    test_front<0, kd_tree_tag>(5);
    test_front<5, boost_tree_tag>(5);
    test_front<5, r_tree_tag>(5);
    test_front<0, r_tree_tag>(5);
    test_front<5, r_star_tree_tag>(5);
    test_front<0, r_star_tree_tag>(5);
}
...
TEST_CASE("Front - 9 dimensions") {
    ...
    test_front<0, quad_tree_tag>(9);
    test_front<9, kd_tree_tag>(9);
    test_front<0, kd_tree_tag>(9);
    test_front<9, boost_tree_tag>(9);
    test_front<9, r_tree_tag>(9);
    test_front<0, r_tree_tag>(9);
    test_front<9, r_star_tree_tag>(9);
    test_front<0, r_star_tree_tag>(9);
}
...
TEST_CASE("Front - 13 dimensions") {
    ...
    test_front<0, quad_tree_tag>(13);
    test_front<13, kd_tree_tag>(13);
    test_front<0, kd_tree_tag>(13);
    test_front<13, boost_tree_tag>(13);
    test_front<13, r_tree_tag>(13);
    test_front<0, r_tree_tag>(13);
