...
// #define __cpp_lib_memory_resource 201603
    ...
    class polymorphic_allocator
    {
        ...
        struct __not_pair<std::pair<_Up1, _Up2>> { };
        ...
        template<bool, typename _Tp1, typename _Alloc, typename... _Args>
        struct __uses_alloc;
        ...
        struct __uses_alloc<true, _Tp1, _Alloc, _Args...>
                : conditional<
                        is_constructible<_Tp1, allocator_arg_t, _Alloc, _Args...>::value,
                        __uses_alloc1<_Alloc>,
                  __uses_alloc2<_Alloc>>::type
        {
            static_assert(__or_<
                          is_constructible<_Tp1, allocator_arg_t, _Alloc, _Args...>,
            is_constructible<_Tp, _Args..., _Alloc>>::value, "construction with"
                                                             " an allocator must be possible if uses_allocator is true");
        };

        template<typename _Tp1, typename _Alloc, typename... _Args>
        struct __uses_alloc<false, _Tp1, _Alloc, _Args...>
                : __uses_alloc0 { };

        template<typename _Tp1, typename _Alloc, typename... _Args>
        using __uses_alloc_t =
        __uses_alloc<uses_allocator<_Tp1, _Alloc>::value, _Tp1, _Alloc, _Args...>;

        template<typename _Tp1, typename _Alloc, typename... _Args>
        inline __uses_alloc_t<_Tp1, _Alloc, _Args...>
        __use_alloc(const _Alloc& __a)
        {
            __uses_alloc_t<_Tp1, _Alloc, _Args...> __ret;
            __ret._M_a = std::addressof(__a);
            return __ret;
        }
    ...
    public:
        ...
        construct(_Tp1* __p, _Args&&... __args)
        {
            ...
            using __use_tag
            = __uses_alloc_t<_Tp1, polymorphic_allocator, _Args...>;
