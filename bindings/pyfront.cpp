...
void binding_for_N_dimensional(py::module &m) {
    ...
    using pareto_archive_type = std::conditional_t<std::is_same_v<TAG,void>, archive<double, N, py::object>, archive<double, N, py::object, TAG>>;
...
/// Create bindings for pareto_front<double, n, object>
